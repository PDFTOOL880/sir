  ...
  ar: [
    {
      title: 'الأدوات',
      links: [
        { name: 'تحويل PDF إلى Word', href: '/tools/pdf-to-word' },
        { name: 'تحويل Word إلى PDF', href: '/tools/word-to-pdf' },
...
export function Footer() {
  ...
  const currentLang = (i18n.language || 'en') as 'ar' | 'en';
    ...
    <footer className="bg-white dark:bg-gray-800">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {(footerLinks[currentLang] || footerLinks['en']).map((section) => (
        ...
        <div className="pt-8 mt-8 border-t border-gray-900/10 dark:border-gray-700/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-8">
              ...
              >
                {contactInfo[currentLang]?.needHelp || contactInfo['en'].needHelp}
              </Link>
            </div>
          </div>
        </div>
